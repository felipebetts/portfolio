    ...
    return (
        <Layout title="Works | Valepay">
            <Container>
                ...
                <P>
                    This project is a digital banking platform built to suit
                    specifical needs from the tourism industry. It can perform
                    transactions, payment antecipation, manage users, and much
                    more.
                </P>
                <P>
                    I was responsible for building the front-end project for the
                    platform&apos;s multiple scopes. I used Next.js, a React
                    production framework. The style was implemented using Styled
                    Components. This allowed me to build custom components such
                    as calendars, responsive sidebar, paginated tables and a lot
                    others. Axios was used to perform the requests to the
                    server. By using axios, I was able to treat requests and
                    responses with custom middlewares, adding authetication and
                    error treatment.
                </P>
                <P>
                    The platform is yet to be launched, but very soon it will
                    be.
                </P>
                {/* <Box
                    my={3}
